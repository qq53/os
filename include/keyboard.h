...
/*
  -----------------------------------
  Create date: 2013-11-30 21:04
  Modified date: 2013-12-01 15:07
  Author: Sen1993
...
#define FLAG_EXT		0x100		/* Normal function keys	*/
#define FLAG_SHIFT_L	0x200		/* Shift key			*/
#define FLAG_SHIFT_R	0x400		/* Shift key			*/
#define FLAG_CTRL_L		0x800		/* Control key			*/
...
typedef struct s_kb 
{
		int		head;				/* 指向缓冲区中下一个空闲位置 */
		int		tail;				/* 指向键盘任务应处理的字节 */
		int		count;				/* 有多少字节的数据 */
